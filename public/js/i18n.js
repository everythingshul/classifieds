const I18N = (() => {
  const DICT = {
    en: {
      ...
      sunrise: 'Sunrise', sunset: 'Sunset', tzeit: 'Tzeit Hakochavim', chatzot: 'Chatzot',
      sof_zman_shma: 'Sof Zman Shma', mincha_gedola: 'Mincha Gedola', plag_hamincha: 'Plag HaMincha',
    ...
    he: {
      ...
      sunrise: 'הנץ החמה', sunset: 'שקיעה', tzeit: 'צאת הכוכבים', chatzot: 'חצות',
      sof_zman_shma: 'סוף זמן קריאת שמע', mincha_gedola: 'מנחה גדולה', plag_hamincha: 'פלג המנחה',
